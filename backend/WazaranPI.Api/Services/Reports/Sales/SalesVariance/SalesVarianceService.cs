...
{
    return await _repository.GetSalesVarianceFiltersAsync(salespointcd);
}
        ...
        {
              var data = (await _repository.GetSalesVarianceAsync(
                branches,
                salesmen,
                customers,
                channels
...
)
{
    ...
    ws.Cell(1, 3).Value = "Customer Group";
    ws.Cell(1, 4).Value = "Branch Code";
    ws.Cell(1, 5).Value = "Branch Name";
    ws.Cell(1, 6).Value = "Salesman Number";
    ws.Cell(1, 7).Value = "Salesman Name";
    ws.Cell(1, 8).Value = "Salesman Phone";
    ws.Cell(1, 9).Value = "Current Year";
    ws.Cell(1, 10).Value = "Last Year";
    ws.Cell(1, 11).Value = "Variance";
    ...
    ws.Range(1, 1, 1, 11).Style.Fill.BackgroundColor = XLColor.FromHtml("#0D9488");
